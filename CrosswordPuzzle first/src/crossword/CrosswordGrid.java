...
class CrosswordGrid extends JPanel {
	...
	public void checkClueSolved(Clue clue, int direct, String username) {
		boolean solved = true;
		String direction;
		...
		if (solved && checkPuzzleSolved()) {// solved and whole puzzle solved
			score = 122;
			mainFrame.appendLog(Tools.getTime()+"\n\t\""+ mainFrame.getCurrentCrossword() + "\""+ " CLEAR!!\n"+"\t최종 점수 : "+ score+ "\n");
		}
	}
